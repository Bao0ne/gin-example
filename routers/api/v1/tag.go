...
import (
	"github.com/Bao0ne/gin-example/models"
	"github.com/Bao0ne/gin-example/pkg/e"
	"github.com/Bao0ne/gin-example/pkg/setting"
	"github.com/Bao0ne/gin-example/pkg/util"
...
func EditTag(c *gin.Context)  {
	...
	valid.Required(modifiedBy, "modified_by").Message("修改人最长为100字符")
	valid.MaxSize(name, 100, "name").Message("名称最长为100字符")

	code := e.INVALID_PARAMS
	if ! valid.HasErrors(){
		code = e.SUCCESS
		if models.ExistTagByName(string(id)) {
			data := make(map[string]interface{})
